...
def plot_all_stats(stats: Dict, save_dir: str = None, show: bool = True):
    ...
    if save_dir:
        ...
        plot_training_stats(stats, os.path.join(save_dir, 'training_stats.png'), show)
        plot_win_distribution(stats, os.path.join(save_dir, 'win_distribution.png'), show)
        plot_loss_distribution(stats, os.path.join(save_dir, 'loss_distribution.png'), show)
    else:
        plot_training_stats(stats, None, show)
        plot_win_distribution(stats, None, show)
        plot_loss_distribution(stats, None, show) 