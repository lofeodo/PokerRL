...
class SlumbotIntegration:
    ...
    def __init__(self, blueprint_path=None, max_depth=3, enable_learning=True):
        ...
        self.losses = 0
        self.ties = 0
        self.hand_winnings_history: List[int] = []
    ...
    def play_session(self, num_hands: int, username: Optional[str] = None, password: Optional[str] = None) -> Dict:
        ...
        for h in range(num_hands):
            ...
            self.hand_winnings_history.append(hand_winnings)
            self.hands_played += 1
        ...
        from slumbot_visualization import visualize_session
        visualize_session(self.hand_winnings_history, stats)
